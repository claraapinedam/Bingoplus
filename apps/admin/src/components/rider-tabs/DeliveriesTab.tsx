  ...
  return (
    <div>
      <p style={{ fontSize: 13, color: '#7f8ea3', marginBottom: 14 }}>
        {deliveries?.length ?? '—'} entrega(s) de este rider. La tarifa de delivery mostrada es el monto total cobrado
        en el pedido; parte de ese monto corresponde a la comisión del negocio sobre el pedido (ver Comisiones dentro
        del negocio), no es ganancia exclusiva del rider.
      </p>
      ...
      <div className="bingo-card">
        {deliveries === null ? (
          ...
          <p>Este rider no tiene entregas en este filtro.</p>
        ) : (
