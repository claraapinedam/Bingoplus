// Renders the real "Política de Privacidad y Tratamiento de Datos Personales — Clientes BINGO+"
...
// two-level "N."/"N.N." numbered headers), matching apps/rider's pair of documents.
const DOC_TITLE_LINES = new Set(['POLÍTICA DE PRIVACIDAD Y TRATAMIENTO DE DATOS PERSONALES', 'CLIENTES BINGO+']);
