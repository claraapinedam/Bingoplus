...
// and not a fit to bolt a bidirectional multi-app chat onto for this feature's scope). Same
// cadence the tracking page falls back to when its own socket isn't connected.
  ...
  return (
    <CustomerShell>
      <header className="bingo-header">
        ...
        <div className="bingo-header-sub">Chat de soporte</div>
      </header>
          ...
          <div className="bingo-card" style={{ textAlign: 'center' }}>
            ...
            {chat.ratingScore != null && (
              <div style={{ marginTop: 8 }}>
                <RatingStars value={chat.ratingScore} readOnly />
              </div>
            )}
          </div>
        )}
