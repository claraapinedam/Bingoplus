...
/** A single-image field that uploads from the device instead of asking for a URL — used for the
 * business's logo/cover (Perfil) and anywhere else a single image is needed. */
