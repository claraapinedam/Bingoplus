...
export default function EmailField({
  ...
  /** 'inline' wraps the input inside the label (login/register screens). 'block' renders the
   * label as its own element above the input, matching forms laid out in a grid (e.g.
   * BusinessApplyForm's `dashboard-form-grid`). */
